    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-3">Kitchen Admin</div>
            </a>
            ...
            <x-admin-sidebar-item-links></x-admin-sidebar-item-links>


            <x-admin-sidebar-ingredient-links></x-admin-sidebar-ingredient-links>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kitchen 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
